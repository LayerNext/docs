...
The list of all available system labels can be retrieved from this function.
...
To create a new ontology(label) group, use the below function.
...
The list of all available ontology(label) groups can be obtained from
